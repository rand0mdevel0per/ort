...
use ort_core::suite::{ecdh::Ecdh, fresh_r, pqc::Pqc, CipherSuite, SuiteId};
...
#[test]
fn v1_kem_roundtrip() {
    kem_roundtrip(SuiteId::MlKem768MlDsa65, Pqc::KEM_EK_LEN, Pqc::KEM_CT_LEN);
}

#[test]
fn v2_kem_roundtrip() {
    kem_roundtrip(SuiteId::X25519Ed25519, Ecdh::KEM_EK_LEN, Ecdh::KEM_CT_LEN);
}
...
#[test]
fn v1_sig_roundtrip() {
    sig_roundtrip(SuiteId::MlKem768MlDsa65, Pqc::SIG_VK_LEN, Pqc::SIG_LEN);
}

#[test]
fn v2_sig_roundtrip() {
    sig_roundtrip(SuiteId::X25519Ed25519, Ecdh::SIG_VK_LEN, Ecdh::SIG_LEN);
}
...
fn v1_implicit_rejection() {
    let secret = ServerKemKey::generate(SuiteId::MlKem768MlDsa65);
    let bogus = vec![0xABu8; Pqc::KEM_CT_LEN];
